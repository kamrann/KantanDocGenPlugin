...
NOTE: You should call <<K2_FetchExternalUpdatesAsync>> at particular times in your application when you want to ensure that the state is up-to-date - the plugin will apply rate-limiting internally if you try to call it too often.
